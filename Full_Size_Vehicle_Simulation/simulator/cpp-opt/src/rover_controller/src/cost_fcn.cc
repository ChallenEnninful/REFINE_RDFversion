...
//  if (std::abs(h_des) < 0.1) {  // slightly less than 30[deg]
//    weight_h = 0.1;
//    weight_xy = 10;
//  }
//#else
...
//
//  if (std::abs(h_des) < 0.15) {  // slightly less than 8.6[deg]
//    weight_h = 1.0;
//    weight_xy = 10.0;
//  }
//#endif

//  std::cout << "wh: " << weight_h << ", wxy: " << weight_xy << std::endl;
  ret_val.cost_k_ =
